...
#include "src/model/osd/cms/osd_set_weather_request.h"
#include "src/model/base_response.h"
#include "src/model/osd/weather_model.h"
#include "src/shared/config/osd_cms_config.h"
#include "src/usecase/osd/cms/i_osd_cms.h"

class OSDCMSWeatherData : public HttpClientWrapper, public IOSDCMS<WeatherModel, OSDSetWeatherRequest>
{
    Q_OBJECT
public:
