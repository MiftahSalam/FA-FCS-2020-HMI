...
public:
    ...
    static OSDStreamPosition* getInstance(TcpMessagingOpts *config, OSDPositionRepository *_repoPos);
...
protected:
    OSDStreamPosition(TcpMessagingOpts *config = nullptr, OSDPositionRepository *repoPos = nullptr);
