...
OSDPositionEntity::OSDPositionEntity(double latitude, double longitude, const std::string &source, const std::string &status, const bool &mode) : OSDBaseEntity(source, status, mode),
    _latitude(latitude),
