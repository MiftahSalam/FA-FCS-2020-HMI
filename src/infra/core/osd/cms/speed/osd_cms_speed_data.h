...
class OSDCMSSpeedData: public HttpClientWrapper, public ICmsHttp<SpeedResponseModel, OSDSetSpeedRequest>
{
    Q_OBJECT
public:
...
signals:
    void signal_setSpeedResponse(BaseResponse<SpeedResponseModel> response);
...
private:
    ...
    BaseResponse<SpeedResponseModel> toResponse(QNetworkReply::NetworkError err, QByteArray raw) override;
};
