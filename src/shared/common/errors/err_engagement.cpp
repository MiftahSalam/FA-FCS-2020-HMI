...
ErrEngagementInvalidIdentity::ErrEngagementInvalidIdentity() : BaseError(ERROR_CODE_ENGAGEMENT_IDENTITY_NOT_VALID.first, ERROR_CODE_ENGAGEMENT_IDENTITY_NOT_VALID.second)
{
